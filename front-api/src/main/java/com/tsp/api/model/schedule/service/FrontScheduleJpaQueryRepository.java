...
import static com.tsp.api.model.domain.schedule.FrontScheduleEntity.toDtoList;
import static com.tsp.api.model.domain.schedule.QFrontScheduleEntity.frontScheduleEntity;
...
@Repository
public class FrontScheduleJpaQueryRepository {
    ...
    public List<FrontModelDTO> findModelScheduleList(Map<String, Object> scheduleMap) {
        ...
        return findModelScheduleList != null ? FrontModelEntity.toDtoList(findModelScheduleList) : emptyList();
    }
}

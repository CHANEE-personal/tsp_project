...
import com.tsp.api.model.domain.recommend.QFrontRecommendEntity;
import com.tsp.api.model.domain.search.FrontSearchDTO;
import com.tsp.api.model.domain.search.FrontSearchEntity;
import com.tsp.api.model.domain.search.QFrontSearchEntity;
...
import static com.tsp.api.model.domain.FrontModelEntity.toDto;
import static com.tsp.api.model.domain.FrontModelEntity.toDtoList;
import static com.tsp.api.model.domain.QFrontModelEntity.frontModelEntity;
import static com.tsp.api.model.domain.agency.QFrontAgencyEntity.frontAgencyEntity;
import static com.tsp.common.utils.StringUtil.getInt;
...
public class FrontModelJpaQueryRepository {
    ...
    private BooleanExpression searchCategory(Map<String, Object> modelMap) {
        ...
        return frontModelEntity.newModelCodeJpaDTO.categoryCd.eq(categoryCd);
    }
    ...
    public FrontModelDTO findPrevOneModel(Long idx, Integer categoryCd) {
        ...
        FrontModelEntity findPrevOneModel = Optional.ofNullable(queryFactory
                .selectFrom(frontModelEntity)
                .orderBy(frontModelEntity.idx.desc())
                .where(frontModelEntity.idx.lt(idx)
                        .and(frontModelEntity.newModelCodeJpaDTO.categoryCd.eq(categoryCd))
                        .and(frontModelEntity.visible.eq("Y")))
    ...
    public FrontModelDTO findNextOneModel(Long idx, Integer categoryCd) {
        ...
        FrontModelEntity findNextOneModel = Optional.ofNullable(queryFactory
                ...
                .where(frontModelEntity.idx.gt(idx)
                        .and(frontModelEntity.newModelCodeJpaDTO.categoryCd.eq(categoryCd))
                        .and(frontModelEntity.visible.eq("Y")))
                .fetchFirst()).orElseThrow(() -> new TspException(NOT_FOUND_MODEL));
